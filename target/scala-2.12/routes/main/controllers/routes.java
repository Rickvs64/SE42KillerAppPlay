...
public class routes {
  ...
  public static final controllers.ReverseCustom5Controller Custom5Controller = new controllers.ReverseCustom5Controller(RoutesPrefix.byNamePrefix());
  public static final controllers.ReverseCustom1Controller Custom1Controller = new controllers.ReverseCustom1Controller(RoutesPrefix.byNamePrefix());
  public static final controllers.ReverseCustom3Controller Custom3Controller = new controllers.ReverseCustom3Controller(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseCustom5Controller Custom5Controller = new controllers.javascript.ReverseCustom5Controller(RoutesPrefix.byNamePrefix());
    public static final controllers.javascript.ReverseCustom1Controller Custom1Controller = new controllers.javascript.ReverseCustom1Controller(RoutesPrefix.byNamePrefix());
    public static final controllers.javascript.ReverseCustom3Controller Custom3Controller = new controllers.javascript.ReverseCustom3Controller(RoutesPrefix.byNamePrefix());
